...
The 10-year Treasury holding steady near 4.78% is keeping a lid on the broad market's upside—the Nasdaq barely budged today despite tech's typical rate sensitivity—while the S&P 500's 0.55% decline signals investors are reassessing which tech narratives justify current valuations. Against this backdrop of sideways macro conditions, the sector is showing signs of bifurcation: established chip and infrastructure players like AMD and HPE are finding buyers on the dip, suggesting confidence in mature, cash-generative businesses, while companies chasing AI's promise—from energy providers betting on 2027 payoffs to software firms benchmarking their AI economics—face tighter scrutiny on when those investments actually accrete value.
Tickers: $AMD, $HPE, $MSFT
Sources: Yahoo
